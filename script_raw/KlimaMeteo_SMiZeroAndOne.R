...
'
- "./data/data_proj/","MeteoMonth_df_tidy_", namelist_RCMs[[i]],".csv" <- KlimaMeteo_netcdf_to_sf&tidy.R
...
'
-"./figures/figures_exploratory/Proj/SMI/oneAndZero_table.csv
...
Climate_filter_one_table_colSums_list <- list()
Climate_filter_zero_table_colSums_list <- list()
...
for (i in 1:length(namelist_RCMs)){
  ...
  Climate_filter_one_table_colSums <- as.data.frame(colSums( Climate_filter_one_table))
  Climate_filter_zero_table_colSums <- as.data.frame(colSums( Climate_filter_zero_table))
  
  names(Climate_filter_one_table_colSums)  <- paste("colsums zeros", namelist_RCMs[i])
  names(Climate_filter_zero_table_colSums) <- paste("colsums ones", namelist_RCMs[i])
  
  Climate_filter_one_table_colSums$year <- rownames(Climate_filter_one_table_colSums)
  Climate_filter_zero_table_colSums$year <- rownames(Climate_filter_zero_table_colSums)
  
  rownames(Climate_filter_one_table_colSums) <- rownames(Climate_filter_zero_table_colSums) <- NULL
  
  Climate_filter_one_table_colSums_list[[i]] <-   Climate_filter_one_table_colSums
  Climate_filter_zero_table_colSums_list[[i]] <-   Climate_filter_zero_table_colSums
  
  #################################################################################
  #### Export table indicating the distribution of zeros or ones for each year ####
  ...
  # write.csv( Climate_filter_one_table_colSums,  file=paste("./figures/figures_exploratory/Proj/SMI/one_table_", namelist_RCMs[[i]],".csv", sep=""  ))
  # write.csv( Climate_filter_zero_table_colSums, file=paste("./figures/figures_exploratory/Proj/SMI/zero_table_", namelist_RCMs[[i]],".csv", sep=""  )) 
  # 
  
  ######################################################################
  #### Export plots of the zero and one distribtution for each year ####
...
###################################################################
#### Merge data in Climate_filter_one_table_colSums_list[[i]] ####
#################################################################
Climate_filter_one_table_colSums_list_join <- full_join(full_join(full_join(full_join(Climate_filter_one_table_colSums_list[[1]], Climate_filter_one_table_colSums_list[[2]], by="year"),
                                                        Climate_filter_one_table_colSums_list[[3]], by="year"),
                                                        Climate_filter_one_table_colSums_list[[4]], by="year"),
                                                        Climate_filter_one_table_colSums_list[[5]], by="year")

Climate_filter_zero_table_colSums_list_join  <- full_join(full_join(full_join(full_join(Climate_filter_zero_table_colSums_list[[1]], Climate_filter_zero_table_colSums_list[[2]], by="year"),
                                                                            Climate_filter_zero_table_colSums_list[[3]], by="year"),
                                                                  Climate_filter_zero_table_colSums_list[[4]], by="year"),
                                                        Climate_filter_zero_table_colSums_list[[5]], by="year")

  
Climate_filter_oneAndZero_table_colSums_list_join  <- full_join(Climate_filter_one_table_colSums_list_join  , Climate_filter_zero_table_colSums_list_join, by="year" )
                                                        

Climate_filter_oneAndZero_table_colSums_list_join2 <-   
  Climate_filter_oneAndZero_table_colSums_list_join[, c(2,1,3:dim(Climate_filter_oneAndZero_table_colSums_list_join)[2])]

Climate_filter_oneAndZero_table_colSums_list_join3 <- Climate_filter_oneAndZero_table_colSums_list_join2[order(Climate_filter_oneAndZero_table_colSums_list_join2$year),]

write_csv(Climate_filter_oneAndZero_table_colSums_list_join3, "./figures/figures_exploratory/Proj/SMI/oneAndZero_table.csv")
